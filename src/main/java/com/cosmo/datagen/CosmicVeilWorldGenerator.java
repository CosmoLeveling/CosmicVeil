...
public class CosmicVeilWorldGenerator extends FabricDynamicRegistryProvider {
    public CosmicVeilWorldGenerator(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
