...
public enum ModArmorMaterials implements ArmorMaterial {
    SHADOW_MONARCH("shadow", 37, new int[]{3, 6, 8, 3}, 25, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.0F, 0.1F, () -> Ingredient.ofItems(ItemInit.Ashenite));
    ...
    public int getDurability(ArmorItem.Type type) {
        return new int[]{13,15,16,11}[type.getEquipmentSlot().getEntitySlotId()] * this.durabilityMultiplier;
    }
