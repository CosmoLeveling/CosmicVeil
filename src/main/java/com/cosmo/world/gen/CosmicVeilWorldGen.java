...
import com.cosmo.world.generator.SolarRealmChunkGenerator;
...
public class CosmicVeilWorldGen {
    public static void generateWorldGen(){
        ...
        Registry.register(Registries.CHUNK_GENERATOR,new Identifier(CosmicVeil.MOD_ID, "solar_chunkgen"), SolarRealmChunkGenerator.CODEC);
    }
}
